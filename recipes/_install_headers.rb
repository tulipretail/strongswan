remote_file "/var/tmp/linux-image-3.8.4-joyent-ubuntu-12-opt_1.0.0_amd64.deb" do
  source "https://s3.amazonaws.com/public.tulip.io/linux-image-3.8.4-joyent-ubuntu-12-opt_1.0.0_amd64.deb"
end

remote_file "/var/tmp/linux-headers-3.8.4-joyent-ubuntu-12-opt_1.0.0_amd64.deb" do
  source "https://s3.amazonaws.com/public.tulip.io/linux-headers-3.8.4-joyent-ubuntu-12-opt_1.0.0_amd64.deb"
end
